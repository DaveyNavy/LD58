...
public class Damagable : MonoBehaviour
{
    ...
    public int _damageSoundTimer;
    public bool _shouldPlayDamageSound = false;
    ...
    protected virtual void FixedUpdate()
    {
        ...
        if (_damageSoundTimer == 0 && _shouldPlayDamageSound)
        {
            ...
            SoundManager.Instance.PlayOneShot(SoundManager.Instance.attack4, 0.7f, pitch);
        }
    }
    ...
    public virtual bool TakeDamage(int amount)
    {
        ...
        vfx.transform.localScale = transform.localScale * 5;
    ...
    public virtual void OnDeath()
    {
        ...
        vfx.transform.localScale = transform.localScale * 5f;
        vfx.Play();
